...
The engine uses Phong Lighting for the 3D meshes and can also do 2D rendering, I've listed the functions that this engine can be called at the bottom of this document.
...
In this project I have used some files that I recieved while studying like the openGL libraries as I started this as a uni project and then continued it out of uni.
